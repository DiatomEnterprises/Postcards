class PostcardsController < ApplicationController
  ...
  def index
    render json: Receiver.limit(5)
  end
  
  def create
    binding.pry
    render json: Receiver.create(name: params[:name])
  end

  # def update
  #   render json:  Receiver.update(safe_params[:id], safe_params)
  # end
  ...
  #   redirect_to action: 'index', id: @receiver.id
  # end
